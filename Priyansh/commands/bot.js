...
if ([
 ...
 if ([
  ...
  if ((event.body.toLowerCase() == "morning") || (event.body.toLowerCase() == "good morning")) {
   ...
   if ((event.body.toLowerCase() == "Shehzada") || (event.body.toLowerCase() == "SHEHZADA") || (event.body.toLowerCase() == "shehzada") || (event.body.toLowerCase() == "Shehzada")) {
  ...
  if ((event.body.toLowerCase() == "bot admin") || (event.body.toLowerCase() == "bot ka admin kon ha")) {
   ...
   if ((event.body.toLowerCase() == "Aslamo Alykom") || (event.body.toLowerCase() == "Slam") || (event.body.toLowerCase() == "ASLAMO ALYKOM")) {
    return api.sendMessage("️WALAIKOM ASLAM 😇", threadID);
   };
